...
export class CreateProductAttributesTable1772117079538 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "uq_product_attributes_product_id_display_order_active" ON "product_attributes" ("product_id", "display_order") WHERE "is_active" = true`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."uq_product_attributes_product_id_display_order_active"`,
    );
